...
function Verifie (ditaSearch_Form) {
    ...
    expressionInput=encodeURI(parent.frames['searchwin'].document.ditaSearch_Form.textToSearch.value)
...
function Effectuer_recherche(expressionInput) {
            ...
            for (i = cpt-1;i>=0;i--) {
                if (fileAndWordList[i] != undefined) {
                    ...
                    for (t in fileAndWordList[i]) {
                        ...
                        linkString = "<li><a target=\"contentFrame\" href=\"content/"+tempPath+"\">"+tempTitle+"</a>";
      ...
      /* Display results */
        with (parent.frames['searchresults'].document) {
                ...
                // updated 5/6/16 to fix xss issue CSC-1323
	               if ( txt_wordsnotfound != "" ) {writeln("<p>"+"Your search returned no results for "+ "<span class=\"searchExpression\">" + txt_wordsnotfound.replace("<","&lt;").replace(">","&gt;") + "</span>" +"</p>")}
