...
<!-- ********************************************************************
     $Id: block.xsl,v 1.11 2007/03/09 21:56:20 dcramer Exp $
     ********************************************************************
...
<!-- ==================================================================== -->
<!-- Adding the predicate [not(parent::footnote)] to avoid taking precedence over the footnote/para template   -->
<!-- From Bob Stayton on DocBook apps: This is one of the gotchas of XSL import precedence.  This template in fo/footnote.xsl:
...
<!-- DWC: Adding [1] predicate to para because we have customized the
  dtd such that formal paras can now contain more than one para.  -->
<xsl:template match="formalpara/para[1]" priority="1">
  <xsl:apply-templates/>
</xsl:template>
