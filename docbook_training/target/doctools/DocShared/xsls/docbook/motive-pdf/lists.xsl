...
<!-- ********************************************************************
     $Id: lists.xsl,v 1.11 2007/02/21 22:39:09 dcramer Exp $
     ********************************************************************
...
<xsl:template match="simplelist">
  ...
  <fo:table table-layout="fixed" xsl:use-attribute-sets="normal.para.spacing"> <!-- JCBG-76, added table-layout="fixed" to prevent SEVERE: table auto error-->
