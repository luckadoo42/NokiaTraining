...
<!-- ********************************************************************
     $Id: formal.xsl,v 1.11 2007/02/21 22:39:09 dcramer Exp $
     ********************************************************************
...
<xsl:param name="motiveff"  select="translate(concat($common.graphics.path,'/ff.svg'), '\','/')"/> <!-- for jcbg-76, added translate to convert \ to / -->
  ...
  <fo:block xsl:use-attribute-sets="formal.title.properties">
    <xsl:choose>
	  ...
	  <xsl:if test="local-name(.) = 'procedure'">
		...
		<fo:external-graphic src="url({$motiveff})" padding-left=".05em" padding-right=".7em"/>
	  </xsl:if>
