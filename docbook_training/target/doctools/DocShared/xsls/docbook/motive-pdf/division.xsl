...
<!-- ********************************************************************
     $Id: division.xsl,v 1.6 2007/02/21 22:39:09 dcramer Exp $
     ********************************************************************
...
<xsl:template match="book">
  ...
  <xsl:if test="$preamble">
    <fo:page-sequence hyphenate="{$hyphenate}"
      ...
      <xsl:attribute name="initial-page-number">2</xsl:attribute><!-- Forcing this because of our full page cover. -->
      <xsl:attribute name="force-page-count">
        <xsl:call-template name="force.page.count">
          <xsl:with-param name="master-reference" 
	                  select="$titlepage-master-reference"/>
...
<xsl:template match="part" mode="part.titlepage.mode">
  ...
  <xsl:variable name="titlepage-master-reference">
	...
	<xsl:call-template name="motive.part.cover">
