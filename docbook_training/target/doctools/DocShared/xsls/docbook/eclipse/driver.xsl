...
<xsl:stylesheet 
  ...
  <xsl:param name="PLANID" select="NO-PLANID-FOUND"/>  
  <xsl:param name="BUILDNUMBER" select="NO-BUILDNUMBER-FOUND"/>  
...
<xsl:text>
	...
	<xsl:if test="$PLANID">
	  <meta name="Bamboo-build" content="{$PLANID}-{$BUILDNUMBER}"/> 
	</xsl:if>
	<xsl:if test="$hostname">
	  <meta name="build-info-maker" content="DocShared\docbook\eclipse\driver.xsl"/> 
