...
<xsl:stylesheet 
  ...
  <xsl:import href="../xhtml/nokia1.xsl"/>
...
<xsl:param name="eclipse.plugin.provider">Nokia</xsl:param>
...
<xsl:text>
	...
	<meta name="copyright"> <!-- JCBG-1845: Refactor code to get copyright. -->
	  <xsl:attribute name="content">Copyright (c) <xsl:value-of select="//bookinfo[1]/copyright"/> </xsl:attribute>
	</meta>
<xsl:text>
</xsl:text>
	<xsl:if test="$hostname">
	  <meta name="build-info-maker" content="DocShared\docbook\eclipse\nokia1.xsl"/> 
