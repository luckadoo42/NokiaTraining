...
<!-- ********************************************************************
     $Id: xref.xsl,v 1.4 2009/04/30 18:16:37 dcramer Exp $
     ********************************************************************
...
<xsl:template match="qandaentry" mode="xref-to">
  ...
  <xsl:param name="xrefstyle"/>
  <xsl:param name="verbose" select="1"/>
<!-- DWC: Back porting fix from DocBook XSLS: http://docbook.svn.sourceforge.net/viewvc/docbook/trunk/xsl/html/xref.xsl?r1=8328&r2=8327&pathrev=8328 -->
