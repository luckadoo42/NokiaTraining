...
<!-- ********************************************************************
     $Id: table.xsl,v 1.10 2007/02/22 05:14:12 dcramer Exp $
     ********************************************************************
...
<xsl:template match="tgroup" name="tgroup">
  ...
  <table>
	  ...
	  <xsl:if test="parent::table[not(contains(child::processing-instruction('bj'),'custom-table-format'))]|parent::informaltable[not(contains(descendant::processing-instruction('bj'),'custom-table-format'))]">
