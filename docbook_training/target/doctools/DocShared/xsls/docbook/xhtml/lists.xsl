...
<!-- ********************************************************************
     $Id: lists.xsl,v 1.14 2009/06/10 15:07:45 dcramer Exp $
     ********************************************************************
...
<xsl:template match="itemizedlist/listitem">
  ...
  <li>
    <xsl:if test="$css.decoration = '1' and $cssmark != ''">
	  ...
	  <!-- DWC: Adding this to pass role on listitem through as a class.  -->
	  <!--      In HomeView, we're doing a special thing where we hid some  -->
	  <!--      content depending on which version of the help they're  -->
	  <!--      looking at. Phrase and para already pass role through as a class. -->
