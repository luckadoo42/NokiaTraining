...
<!-- ********************************************************************
     $Id: qandaset.xsl,v 1.3 2007/06/05 19:46:23 dcramer Exp $
     ********************************************************************
...
<xsl:template match="qandadiv/blockinfo/title|                      qandadiv/info/title|                      qandadiv/title" mode="qandatoc.mode">
  ...
  <xsl:apply-templates select="parent::qandadiv" mode="label.markup"/>
  <!-- This is related to JCBG-385: making the label.separator below 
       conditional because when the labels are turned off, we were still getting a period in the local toc ... -->
  <xsl:if test="$qandadiv.autolabel != 0">
