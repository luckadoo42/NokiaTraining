...
<!-- ********************************************************************
     $Id: param.xsl,v 1.15 2009/11/11 20:37:53 dcramer Exp $
     ********************************************************************
	...
	<xsl:call-template name="make-relative-filename">
	  <xsl:with-param name="base.dir">
		...
		<xsl:choose>
		  ...
		  <xsl:when test="/book/preface">
			<xsl:apply-templates select="/book/preface[1]" mode="chunk-filename"/>
		  </xsl:when>
		  <xsl:when test="/book/chapter[1]">
			<xsl:apply-templates select="/book/chapter[1]" mode="chunk-filename"/>
		  </xsl:when>
		  <xsl:otherwise>
...
<xsl:param name="htmlhelp.button.home.url"><xsl:value-of select="$htmlhelp.default.topic"/></xsl:param>
...
<xsl:param name="id.warnings" select="0"/> <!-- turning off warnings for missing ids, per JCBG-461 -->
...
<!-- changed from 1 to 0 for JCBG-385 -->
...
<xsl:param name="root.filename" select="'index.htm'"/>
...
<xsl:param name="show.comments">1</xsl:param>
  <xsl:param name="show.revisionflag">
	<xsl:choose>
